...
export default function Weather() {
  ...
  return(
    ...
    <div className="w-full max-w-sm p-4 mx-auto my-8 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
    <h5 className="mb-4 text-xl font-medium text-gray-500 dark:text-gray-400">Data for {locationDetails.locations[storeTravelLocation].city} </h5>
    <ul role="list" className="space-y-5 my-7">
       
        <li className="flex space-x-3 items-center">
        <svg xmlns="http://www.w3.org/2000/svg" className="flex-shrink-0 w-10 h-10 text-blue-600 dark:text-blue-500"  aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
